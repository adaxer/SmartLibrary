...
namespace SmartLibrary.Avalonia.Desktop.Platform;
public class DesktopNavigationService : INavigationService
{
    ...
    public DesktopNavigationService(IServiceProvider serviceProvider, IDialogService dialogService, IPubSubService pubsub)
    {
