...
public partial class App : Application
{
    ...
    private void ConfigureServices(IServiceCollection services)
    {
		...
		services.AddSingleton<IBookStorage>(sp=>new BookStorage(sp.GetRequiredService<BooksContext>(), new System.Net.Http.HttpClient { BaseAddress = new Uri("https://localhost:7023", UriKind.Absolute) }));
